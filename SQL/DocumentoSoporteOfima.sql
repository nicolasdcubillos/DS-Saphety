...
VALOR_NETO,
ROUND(((CANTIDAD * ROUND(VALORUNIT, CAST (REDONDEO.VALOR AS INT))) 
ROUND((CANTIDAD * ROUND(VALORUNIT, CAST (REDONDEO.VALOR AS INT))) - (CANTIDAD * ROUND(VALORUNIT, CAST (REDONDEO.VALOR AS INT)) * DESCUENTO), CAST (REDONDEO.VALOR AS INT)) + -- BASE GRABABLE
ROUND(((CANTIDAD * ROUND(VALORUNIT, CAST (REDONDEO.VALOR AS INT))) - (CANTIDAD * ROUND(VALORUNIT, CAST (REDONDEO.VALOR AS INT)) * DESCUENTO)) * IVA / 100, CAST (REDONDEO.VALOR AS INT)) -- MAS EL IVA
SUBTOTAL_NETO
FROM
MVTRADE,
MTGLOBAL REDONDEO
