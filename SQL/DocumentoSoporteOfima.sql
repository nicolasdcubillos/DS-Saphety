...
END VALOR_UNITARIO,
CASE WHEN VALORUNIT > 0 
THEN ROUND(CANTIDAD * VALORUNIT, CAST (REDONDEO.VALOR AS INT))
ELSE CANTIDAD * XVALORUN
END VALOR_PRODUCTOS,
CASE WHEN VALORUNIT > 0
THEN ROUND(CANTIDAD * VALORUNIT * DESCUENTO, CAST (REDONDEO.VALOR AS INT))
ELSE CANTIDAD * XVALORUN * DESCUENTO
END DESCUENTO,
CASE WHEN VALORUNIT > 0
THEN ROUND((CANTIDAD * VALORUNIT) - (CANTIDAD * VALORUNIT * DESCUENTO), CAST (REDONDEO.VALOR AS INT))
ELSE (CANTIDAD * XVALORUN) - (CANTIDAD * XVALORUN * DESCUENTO)
END BASE_GRAVABLE,
CASE WHEN VALORUNIT > 0
THEN ROUND(((CANTIDAD * VALORUNIT) - (CANTIDAD * VALORUNIT * DESCUENTO)) * IVA / 100, CAST (REDONDEO.VALOR AS INT))
ELSE((CANTIDAD * XVALORUN) - (CANTIDAD * XVALORUN * DESCUENTO)) * IVA / 100
END VALOR_IVA,
CASE WHEN VALORUNIT > 0
THEN ROUND(((CANTIDAD * VALORUNIT) - (CANTIDAD * VALORUNIT * DESCUENTO)) * PORETE / 100, CAST (REDONDEO.VALOR AS INT))
ELSE ((CANTIDAD * XVALORUN) - (CANTIDAD * XVALORUN * DESCUENTO)) * PORETE / 100
END VALOR_RTEFTE,
CASE WHEN VALORUNIT > 0
THEN ROUND(((CANTIDAD * VALORUNIT) - (CANTIDAD * VALORUNIT * DESCUENTO)) * PORICA / 100, CAST (REDONDEO.VALOR AS INT))
ELSE((CANTIDAD * XVALORUN) - (CANTIDAD * XVALORUN * DESCUENTO)) * PORICA / 100
END VALOR_RTEICA,
CASE WHEN VALORUNIT > 0
THEN ROUND(((CANTIDAD * VALORUNIT) - ((CANTIDAD * VALORUNIT) * DESCUENTO)) + (((CANTIDAD * VALORUNIT) - ((CANTIDAD * VALORUNIT) * DESCUENTO)) * IVA / 100) - (((CANTIDAD * VALORUNIT) - ((CANTIDAD * VALORUNIT) * DESCUENTO)) * PORETE / 100) - (((CANTIDAD * VALORUNIT) - ((CANTIDAD * VALORUNIT) * DESCUENTO)) * PORICA / 100), CAST (REDONDEO.VALOR AS INT))
