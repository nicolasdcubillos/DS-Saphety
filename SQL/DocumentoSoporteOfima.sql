...
/*
	...
	SELECT * FROM DS_DETALLEDCTO('DI', 38)
*/
...
ELSE (CANTIDAD * VALORUNIT) - (CANTIDAD * VALORUNIT * DESCUENTO)
END BASE_GRAVABLE,
CASE WHEN XVALORUN = 0
...
ELSE((CANTIDAD * VALORUNIT) - (CANTIDAD * VALORUNIT * DESCUENTO)) * IVA / 100
END VALOR_IVA,
CASE WHEN XVALORUN = 0
...
ELSE ((CANTIDAD * VALORUNIT) - (CANTIDAD * VALORUNIT * DESCUENTO)) * PORETE / 100
END VALOR_RTEFTE,
CASE WHEN XVALORUN = 0
...
ELSE((CANTIDAD * VALORUNIT) - (CANTIDAD * VALORUNIT * DESCUENTO)) * PORICA / 100
END VALOR_RTEICA,
CASE WHEN XVALORUN = 0
...
ELSE
((CANTIDAD * VALORUNIT) 
- ((CANTIDAD * VALORUNIT) * DESCUENTO)) 
+ (((CANTIDAD * VALORUNIT) 
- ((CANTIDAD * VALORUNIT) * DESCUENTO)) * IVA / 100) 
- (((CANTIDAD * VALORUNIT) 
- ((CANTIDAD * VALORUNIT) * DESCUENTO)) * PORETE / 100) 
- (((CANTIDAD * VALORUNIT) 
- ((CANTIDAD * VALORUNIT) * DESCUENTO)) * PORICA / 1000)
- ((CANTIDAD * VALORUNIT) - 
(CANTIDAD * VALORUNIT * DESCUENTO)) * IVA / 100 
* (SELECT T.PRETENIVA / 100 FROM TRADE T WHERE T.NRODCTO = MVTRADE.NRODCTO AND T.TIPODCTO = MVTRADE.TIPODCTO AND T.ORIGEN = MVTRADE.ORIGEN)
